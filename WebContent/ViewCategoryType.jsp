          ...
          <div class="card-header">
          	...
          	<div class="card-body">
       			...
       			<div class="row" style="margin-bottom:15px;">
            			<div class="col-md-9">
           				...
           				<div class="col-md-3">
			                	<a class="btn btn-primary btn-block" href="addCategoryType.jsp">
			                		<i class="fas fa-plus"style="margin-right:9px;"></i>Add New Category-Type
			                	</a>
			            </div>
			      </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable">
                ...
                <tbody>
                  <%
                    CategoryTypeDao d=new CategoryTypeDao();
                    List<CategoryTypeBean> list=d.getAllCategoryType();
                  ...
                  <tr>
                  	<td><%=c.getCat_type_id() %></td>
                  	<td><%=c.getCat_type_name() %></td>
                    <td>
                    	<form action="catrgorytypecontroller" method="post">
                  			<input type="hidden" name = "id" value ="<%= c.getCat_type_id()%>">
