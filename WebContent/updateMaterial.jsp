...
<!DOCTYPE html>
<html lang="en">
<% MaterialBean mb=(MaterialBean) request.getAttribute("id"); %>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="card-header heading">Update Material</div>
      <div class="card-body">
        <form onSubmit="return validate()" action="materialcontroller" method="post">
            ...
            <div class="form-row">
              <div class="col-md-12">
                <div class="form-label-group">
                  <input type="hidden" name = "id" value = <%= mb.getMid() %>>
                </div>
              </div>
          </div>
          </div>
          ...
          <div class="form-group">         
            <div class="form-row">
              <div class="col-md-12">
                <div class="form-label-group">
                  <input type="text" name="upmat_name" id="mat-name" class="form-control" placeholder="Material Name" required="required" value="<%= mb.getMname()%>">
  ...
  <jsp:include page="updateMaterialvalidate.jsp"></jsp:include>
