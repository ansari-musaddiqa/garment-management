...
<% ColorBean cb = (ColorBean) request.getAttribute("id"); %>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="card-header heading">Update Color</div>
      <div class="card-body">
      
        <form action="colorcontroller" method = "post" onSubmit="return validate()">
          ...
          <div class="form-group">         
            <div class="form-row">
              <div class="col-md-12">
                <div class="form-label-group">
                  <input type="text" id="colorname" class="form-control" placeholder="Color" name="updatecolor" value=<%= cb.getCnm() %> required="required">
            ...
            <div class="form-row">
              <div class="col-md-12">
                <div class="form-label-group checkchange"> 
                 <input type="checkbox" name="change" value="change" id="colorcheck">Change
                 </div>
              </div>
          </div>
          </div>
		   ...
		   <div class="form-row">
		              <div class="col-md-12">
		                <div class="form-label-group">
		            	  <div class="script1" id="valuecolor">
				  			<label class="form-control valbg" id="txtcolor">Enter Color</label>
				  		  </div>
				  		</div>
				  	</div>
				  	<!--div class="col-md-6">
		                <div class="form-label-group">
		            	  <div class="script1" id="">
		          			<label class="form-control valbg" id="">Enter Description</label>
				  		</div>
				  		</div>
				  	</div-->
			</div>
